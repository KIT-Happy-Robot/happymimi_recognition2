...
#include "happymimi_recognition_msgs2/srv/detail/recognition_count__functions.h"
...
happymimi_recognition_msgs2__srv__RecognitionCount_Request__init(happymimi_recognition_msgs2__srv__RecognitionCount_Request * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->target_name)) {
    happymimi_recognition_msgs2__srv__RecognitionCount_Request__fini(msg);
    return false;
  }
  return true;
}
...
happymimi_recognition_msgs2__srv__RecognitionCount_Request__create()
{
  ...
  happymimi_recognition_msgs2__srv__RecognitionCount_Request * msg = (happymimi_recognition_msgs2__srv__RecognitionCount_Request *)allocator.allocate(sizeof(happymimi_recognition_msgs2__srv__RecognitionCount_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(happymimi_recognition_msgs2__srv__RecognitionCount_Request));
  bool success = happymimi_recognition_msgs2__srv__RecognitionCount_Request__init(msg);
  if (!success) {
...
happymimi_recognition_msgs2__srv__RecognitionCount_Request__Sequence__init(happymimi_recognition_msgs2__srv__RecognitionCount_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  happymimi_recognition_msgs2__srv__RecognitionCount_Request * data = NULL;

  if (size) {
    data = (happymimi_recognition_msgs2__srv__RecognitionCount_Request *)allocator.zero_allocate(size, sizeof(happymimi_recognition_msgs2__srv__RecognitionCount_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = happymimi_recognition_msgs2__srv__RecognitionCount_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        happymimi_recognition_msgs2__srv__RecognitionCount_Request__fini(&data[i - 1]);
      }
...
happymimi_recognition_msgs2__srv__RecognitionCount_Request__Sequence__fini(happymimi_recognition_msgs2__srv__RecognitionCount_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      happymimi_recognition_msgs2__srv__RecognitionCount_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  happymimi_recognition_msgs2__srv__RecognitionCount_Request__Sequence * array = (happymimi_recognition_msgs2__srv__RecognitionCount_Request__Sequence *)allocator.allocate(sizeof(happymimi_recognition_msgs2__srv__RecognitionCount_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = happymimi_recognition_msgs2__srv__RecognitionCount_Request__Sequence__init(array, size);
  if (!success) {
...
happymimi_recognition_msgs2__srv__RecognitionCount_Request__Sequence__destroy(happymimi_recognition_msgs2__srv__RecognitionCount_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    happymimi_recognition_msgs2__srv__RecognitionCount_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
happymimi_recognition_msgs2__srv__RecognitionCount_Request__Sequence__are_equal(const happymimi_recognition_msgs2__srv__RecognitionCount_Request__Sequence * lhs, const happymimi_recognition_msgs2__srv__RecognitionCount_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!happymimi_recognition_msgs2__srv__RecognitionCount_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  happymimi_recognition_msgs2__srv__RecognitionCount_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(happymimi_recognition_msgs2__srv__RecognitionCount_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    happymimi_recognition_msgs2__srv__RecognitionCount_Request * data =
      (happymimi_recognition_msgs2__srv__RecognitionCount_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!happymimi_recognition_msgs2__srv__RecognitionCount_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          happymimi_recognition_msgs2__srv__RecognitionCount_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!happymimi_recognition_msgs2__srv__RecognitionCount_Request__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  happymimi_recognition_msgs2__srv__RecognitionCount_Response * msg = (happymimi_recognition_msgs2__srv__RecognitionCount_Response *)allocator.allocate(sizeof(happymimi_recognition_msgs2__srv__RecognitionCount_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(happymimi_recognition_msgs2__srv__RecognitionCount_Response));
  bool success = happymimi_recognition_msgs2__srv__RecognitionCount_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
happymimi_recognition_msgs2__srv__RecognitionCount_Response__destroy(happymimi_recognition_msgs2__srv__RecognitionCount_Response * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    happymimi_recognition_msgs2__srv__RecognitionCount_Response__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
happymimi_recognition_msgs2__srv__RecognitionCount_Response__Sequence__init(happymimi_recognition_msgs2__srv__RecognitionCount_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  happymimi_recognition_msgs2__srv__RecognitionCount_Response * data = NULL;

  if (size) {
    data = (happymimi_recognition_msgs2__srv__RecognitionCount_Response *)allocator.zero_allocate(size, sizeof(happymimi_recognition_msgs2__srv__RecognitionCount_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = happymimi_recognition_msgs2__srv__RecognitionCount_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        happymimi_recognition_msgs2__srv__RecognitionCount_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
happymimi_recognition_msgs2__srv__RecognitionCount_Response__Sequence__fini(happymimi_recognition_msgs2__srv__RecognitionCount_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      happymimi_recognition_msgs2__srv__RecognitionCount_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  happymimi_recognition_msgs2__srv__RecognitionCount_Response__Sequence * array = (happymimi_recognition_msgs2__srv__RecognitionCount_Response__Sequence *)allocator.allocate(sizeof(happymimi_recognition_msgs2__srv__RecognitionCount_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = happymimi_recognition_msgs2__srv__RecognitionCount_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
happymimi_recognition_msgs2__srv__RecognitionCount_Response__Sequence__destroy(happymimi_recognition_msgs2__srv__RecognitionCount_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    happymimi_recognition_msgs2__srv__RecognitionCount_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
happymimi_recognition_msgs2__srv__RecognitionCount_Response__Sequence__are_equal(const happymimi_recognition_msgs2__srv__RecognitionCount_Response__Sequence * lhs, const happymimi_recognition_msgs2__srv__RecognitionCount_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!happymimi_recognition_msgs2__srv__RecognitionCount_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  happymimi_recognition_msgs2__srv__RecognitionCount_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(happymimi_recognition_msgs2__srv__RecognitionCount_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    happymimi_recognition_msgs2__srv__RecognitionCount_Response * data =
      (happymimi_recognition_msgs2__srv__RecognitionCount_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!happymimi_recognition_msgs2__srv__RecognitionCount_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          happymimi_recognition_msgs2__srv__RecognitionCount_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!happymimi_recognition_msgs2__srv__RecognitionCount_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
