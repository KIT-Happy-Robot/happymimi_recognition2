...
#ifndef HAPPYMIMI_RECOGNITION_MSGS2__SRV__DETAIL__CLIP__FUNCTIONS_H_
#define HAPPYMIMI_RECOGNITION_MSGS2__SRV__DETAIL__CLIP__FUNCTIONS_H_
...
#include "happymimi_recognition_msgs2/srv/detail/clip__struct.h"

/// Initialize srv/Clip message.
/**
...
/// Create srv/Clip message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * happymimi_recognition_msgs2__srv__Clip_Request__init().
...
/// Destroy srv/Clip message.
/**
 * It calls
 * happymimi_recognition_msgs2__srv__Clip_Request__fini()
...
/// Check for srv/Clip message equality.
/**
...
/// Initialize array of srv/Clip messages.
/**
...
/// Finalize array of srv/Clip messages.
/**
 * It calls
 * happymimi_recognition_msgs2__srv__Clip_Request__fini()
...
/// Create array of srv/Clip messages.
/**
 * It allocates the memory for the array and calls
 * happymimi_recognition_msgs2__srv__Clip_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Clip messages.
/**
 * It calls
 * happymimi_recognition_msgs2__srv__Clip_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/Clip message array equality.
/**
...
/// Copy an array of srv/Clip messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * happymimi_recognition_msgs2__srv__Clip_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_happymimi_recognition_msgs2
...
/**
 * It calls
 * happymimi_recognition_msgs2__srv__Clip_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_happymimi_recognition_msgs2
...
/**
 * It allocates the memory for the array and calls
 * happymimi_recognition_msgs2__srv__Clip_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_happymimi_recognition_msgs2
...
/**
 * It calls
 * happymimi_recognition_msgs2__srv__Clip_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // HAPPYMIMI_RECOGNITION_MSGS2__SRV__DETAIL__CLIP__FUNCTIONS_H_
